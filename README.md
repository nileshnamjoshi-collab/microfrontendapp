...
#Start the server of your application locally run below command(s).
http-server ./dist/<folder name of app> -p <port number>

#above command is not needed if you deployed your app(s) on hosted server.
